...
const Header = () => {
  ...
  return <header className="bg-white shadow-lg relative z-50 font-montserrat">
      {/* Skip to main content link for screen readers */}
      <a ref={skipLinkRef} href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-0 focus:left-0 bg-crimson text-white px-4 py-2 z-50 font-medium" tabIndex={0}>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <img src="/logo-ladakh.svg" alt="Government of Ladakh Emblem" className="h-12 w-12 sm:h-16 sm:w-16 object-contain transition-all duration-200" style={{
              minWidth: 48,
              minHeight: 48
            }} />
            ...
            <div className="w-full lg:w-auto lg:min-w-[300px]">
              <form onSubmit={handleSearch} className="relative">
                <Input type="search" placeholder="Search destinations, permits, guides..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pr-12 border-2 border-crimson focus:ring-crimson focus:border-crimson" aria-label="Search tourism information" />
                <Button type="submit" size="sm" aria-label="Submit search" className="absolute right-1 top-1 bg-crimson hover:bg-crimson/90 text-white rounded-2xl font-normal text-base py-0 px-[10px] mx-[6px] my-0">
                  <Search size={16} />
                </Button>
              </form>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <div className="lg:hidden flex items-center gap-2 py-4">
              <Button size="sm" className="bg-crimson hover:bg-crimson/90 text-white">
                Plan Journey
              </Button>
              <Button variant="ghost" size="icon" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} aria-label={isMobileMenuOpen ? "Close menu" : "Open menu"} aria-expanded={isMobileMenuOpen}>
          ...
          {isMobileMenuOpen && <div className="lg:hidden bg-white border-t py-4">
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t flex flex-col gap-3">
                  ...
                  <Button variant="outline" className="border-saffron text-saffron hover:bg-saffron hover:text-white w-full">
                    Apply for Permit
                  </Button>
                </div>
              </div>
