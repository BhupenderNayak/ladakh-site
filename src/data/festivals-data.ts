...
export const FESTIVALS_DATA: Festival[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?ixlib=rb-4.0.3&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    type: 'Religious',
    isUpcoming: false,
    isMarquee: false,
    icon: Calendar,
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?ixlib=rb-4.0.3&q=80&fm=jpg&crop=entropy&cs=tinysrgb',
    type: 'Religious',
    isUpcoming: false,
    isMarquee: false,
    icon: Calendar,
